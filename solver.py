...
class Solver(object):
    ...
    def __init__(self, model, data, **kwargs):
        ...
        print('batch',self.batch_size, ', lr_decay',self.lr_decay)
    ...
    def _step(self):
        ...
        #print('bn params',len(self.model.bn_params))
    ...
    def train(self):
        ...
        print('iters',iterations_per_epoch, ', samples',num_train)
        ...
        for t in range(num_iterations):
            ...
            if self.verbose and t % self.print_every == 0:
                print('(Iteration %d / %d) loss: %f lr: %f' % (t + 1, 
                                                        num_iterations, 
                                                        self.loss_history[-1],
                                                        self.optim_configs['W1']['learning_rate']))
